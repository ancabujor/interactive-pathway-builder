    ...
    <header className="w-full py-3 border-b">
      <div className="flex justify-center items-center space-x-4 sm:space-x-8">
        <div className="flex flex-col items-center">
          <div className={`step-indicator flex items-center justify-center ${currentStep > 1 ? 'bg-green-500 text-white' : currentStep === 1 ? 'bg-blue-500 text-white' : ''}`}>
        ...
        <div className="flex flex-col items-center">
          <div className={`step-indicator flex items-center justify-center ${currentStep > 2 ? 'bg-green-500 text-white' : currentStep === 2 ? 'bg-blue-500 text-white' : ''}`}>
        ...
        <div className="flex flex-col items-center">
          <div className={`step-indicator flex items-center justify-center ${currentStep === 3 ? 'bg-blue-500 text-white' : ''}`}>
            3
          </div>
